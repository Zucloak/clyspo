...
export const IconCapFile = (props: JSX.HTMLAttributes<HTMLDivElement>) => (
  <div {...props} innerHTML={`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-file"><path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/><path d="M14 2v4a2 2 0 0 0 2 2h4"/></svg>`} />
);

export const IconCapCopy = (props: JSX.HTMLAttributes<HTMLDivElement>) => (
    <div {...props} innerHTML={`<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const IconCapCheck = (props: JSX.HTMLAttributes<HTMLDivElement>) => (
    <div {...props} innerHTML={`<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-check"><path d="M20 6 9 17l-5-5"/></svg>`} />
);
